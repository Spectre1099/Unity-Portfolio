...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="relative z-50 bg-background/90 border-b border-border/50 md:fixed md:top-0 md:left-0 md:right-0 md:bg-background/80 md:backdrop-blur-xl"
    >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden overflow-hidden bg-background border-b border-border/50 sm:bg-background/95 sm:backdrop-blur-xl"
          >
